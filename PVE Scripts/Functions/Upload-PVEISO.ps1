...
# Upload-PVEISO -ProxmoxAPI "https://192.168.2.8:8006/api2/json" -Headers $PVEConnect.Headers -Node proxmox1 -Storage vz local -IsoPath "D:\L25-ADDS-01.lab25.lostinazure.com.iso"
